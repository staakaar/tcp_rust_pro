...
impl TCPPacket {
    ...
    pub fn set_seq(&mut self, port: u16) {
        self.buffer[4..8].copy_from_slice(&port.to_be_bytes())
    }

    pub fn set_ack(&mut self, num: u32) {
        self.buffer[8..12].copy_from_slice(&port.to_be_bytes())
    }

    pub fn set_data_offset(&mut self, num: u32) {
